  ...
  render(){
    return(
      <div>
        ...
        <div>
        <h2>As I begin my career as a web developer, I wanted to perfect my front-end development skills, and then further
        pursue fullstack. Using the theory that I learned at Rutgers University, I am confident that I can create
        ...
        <img id="wk" src={wk}></img>
          ...
          study of the language through the use of the WaniKani web service. It is a fullstack project so it
